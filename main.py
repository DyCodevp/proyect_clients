...
def get_Customer(id):
    ...
    consult_json = {"id":consult[0][0], "firstname":consult[0][1], "lastname":consult[0][2], "email":consult[0][3], "phone":consult[0][4], "address":consult[0][5], "date_created":consult[0][6]}
...
def get_AllCustomers():
    ...
    for i in consult:
        consult_json = {"id":i[0], "firstname":i[1],"lastname":i[2], "email":i[3], "phone":i[4], "address":i[5], "date_created":i[6]}
...
def edit_customer():
    ...
    cur = my_sql.connection.cursor()
    cur.execute(f"UPDATE `customers` SET `id` = '{User_data['id']}',`firstname` = '{User_data['firstname']}',`lastname` = '{User_data['lastname']}',`email` = '{User_data['email']}',`phone` = '{User_data['phone']}',`address` = '{User_data['address']}',`date_created` = '{User_data['date_created']}' WHERE `id` = '{User_data['id']}';")
